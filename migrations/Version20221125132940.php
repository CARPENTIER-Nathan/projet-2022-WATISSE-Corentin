 ...
 */
final class Version20221125132940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discussions ADD user_id INT NOT NULL, CHANGE themes_id themes_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discussions DROP user_id, CHANGE themes_id themes_id INT DEFAULT NULL');
    }
}
